...
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { s  }]; #IO_L12N_T1_MRCC_35 Sch=btn[1]
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports { w  }]; #IO_L12N_T1_MRCC_35 Sch=btn[2]
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { rst  }]; #IO_L12N_T1_MRCC_35 Sch=btn[3]
